...
export const STATIC_FIELDS: FieldLayout[] = [
  ...
  },
  {
    ...
    estWidth: 110,
    category: "vendor",
    label: "Szallito adoszam",
    labelEn: "Vendor Tax #",
    fieldPath: "vendor.tax_number",
  },
  {
    id: "vendor.bank_account",
    x: 135,
    y: 178,
    fontSize: 8,
    estWidth: 140,
  ...
  },
  {
    ...
    label: "Szamlaszam",
    labelEn: "Invoice #",
    fieldPath: "header.invoice_number",
  },
  {
    ...
    fieldPath: "header.invoice_date",
  },
  {
    id: "header.fulfillment_date",
    x: 140,
    y: 256,
    fontSize: 9,
    estWidth: 80,
    ...
    label: "Teljesites",
    labelEn: "Fulfillment",
    fieldPath: "header.fulfillment_date",
  },
  {
    id: "header.due_date",
    x: 245,
  ...
  },
  {
    ...
    label: "Penznem",
    labelEn: "Currency",
    fieldPath: "header.currency",
  },
  {
    id: "header.payment_method",
    x: 420,
    y: 256,
    fontSize: 9,
    estWidth: 80,
    ...
    fieldPath: "header.payment_method",
  },
  {
    id: "totals.net_total",
    x: 440,
    ...
    estWidth: 105,
    category: "totals",
    label: "Netto osszesen",
    labelEn: "Net Total",
    fieldPath: "totals.net_total",
  },
  {
    id: "totals.vat_total",
    x: 440,
    ...
    label: "AFA osszesen",
    labelEn: "VAT Total",
    fieldPath: "totals.vat_total",
  },
  {
    id: "totals.gross_total",
    x: 430,
    y: 512,
    fontSize: 13,
    estWidth: 115,
    category: "totals",
    label: "Brutto osszesen",
    labelEn: "Gross Total",
    fieldPath: "totals.gross_total",
  },
];
...
export function lineItemFields(lineIndex: number): FieldLayout[] {
  ...
  return [
    ...
    },
    {
      ...
      label: "AFA %",
      labelEn: "VAT %",
      fieldPath: `${prefix}.vat_rate`,
      lineIndex,
    },
    {
      id: `${prefix}.gross_amount`,
      x: 495,
      y,
      fontSize: 9,
      estWidth: 55,
