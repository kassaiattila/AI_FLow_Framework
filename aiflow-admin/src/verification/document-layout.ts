...
export function lineItemFields(lineIndex: number): FieldLayout[] {
  ...
  return [
    { id: `${prefix}.description`, x: 65, y, fontSize: 9, estWidth: 230, category: "line_item", label: "Megnevezes", fieldPath: `${prefix}.description`, lineIndex },
    { id: `${prefix}.quantity`, x: 288, y, fontSize: 9, estWidth: 30, category: "line_item", label: "Mennyiseg", fieldPath: `${prefix}.quantity`, lineIndex },
    { id: `${prefix}.net_amount`, x: 355, y, fontSize: 9, estWidth: 55, category: "line_item", label: "Netto", fieldPath: `${prefix}.net_amount`, lineIndex },
    { id: `${prefix}.vat_rate`, x: 435, y, fontSize: 9, estWidth: 30, category: "line_item", label: "AFA %", fieldPath: `${prefix}.vat_rate`, lineIndex },
    { id: `${prefix}.gross_amount`, x: 495, y, fontSize: 9, estWidth: 55, category: "line_item", label: "Brutto", fieldPath: `${prefix}.gross_amount`, lineIndex },
  ];
}
